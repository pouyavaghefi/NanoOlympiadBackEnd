<div class="row gutters">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="d-flex justify-content-end mb-3">
            <a href="{{ env('APP_URL') }}/courses/create" class="btn btn-outline-primary">
                <i class="fa fa-plus"></i> Add New Course
            </a>
            <a href="" class="btn btn-primary">
                <i class="fa fa-search"></i> Search
            </a>
            <a href="{{ env('APP_URL') }}/courses/categories/all" class="btn" style="background-color: #6c63ff; color: white;">
                <i class="fa fa-list-alt"></i> Categories
            </a>
{{--            <a href="https://admin.nanolympiad.org/courses/episodes/index" class="btn" style="background-color: #ff5722; color: white;">--}}
{{--                <i class="fa fa-play-circle"></i> Episodes--}}
{{--            </a>--}}
        </div>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="td-actions d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('adm.crs.translate', $course->id) }}"
